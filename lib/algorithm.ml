...
let pp fmt = function
  | RSA -> Fmt.string fmt "RSA"
  | EC_pub _oid -> Fmt.string fmt "EC_pub"
  | MD2_RSA -> Fmt.string fmt "MD2_RSA"
  | MD4_RSA -> Fmt.string fmt "MD4_RSA"
  | MD5_RSA -> Fmt.string fmt "MD5_RSA"
  | RIPEMD160_RSA -> Fmt.string fmt "RIPEMD160_RSA"
  | SHA1_RSA -> Fmt.string fmt "SHA1_RSA"
  | SHA256_RSA -> Fmt.string fmt "SHA256_RSA"
  | SHA384_RSA -> Fmt.string fmt "SHA384_RSA"
  | SHA512_RSA -> Fmt.string fmt "SHA512_RSA"
  | SHA224_RSA -> Fmt.string fmt "SHA224_RSA"
  | ECDSA_SHA1 -> Fmt.string fmt "ECDSA_SHA1"
  | ECDSA_SHA224 -> Fmt.string fmt "ECDSA_SHA224"
  | ECDSA_SHA256 -> Fmt.string fmt "ECDSA_SHA256"
  | ECDSA_SHA384 -> Fmt.string fmt "ECDSA_SHA384"
  | ECDSA_SHA512 -> Fmt.string fmt "ECDSA_SHA512"
  | MD2 -> Fmt.string fmt "MD2"
  | MD4 -> Fmt.string fmt "MD4"
  | MD5 -> Fmt.string fmt "MD5"
  | SHA1 -> Fmt.string fmt "SHA1"
  | SHA256 -> Fmt.string fmt "SHA256"
  | SHA384 -> Fmt.string fmt "SHA384"
  | SHA512 -> Fmt.string fmt "SHA512"
  | SHA224 -> Fmt.string fmt "SHA224"
  | SHA512_224 -> Fmt.string fmt "SHA512_224"
  | SHA512_256 -> Fmt.string fmt "SHA512_256"
  | HMAC_SHA1 -> Fmt.string fmt "HMAC_SHA1"
  | HMAC_SHA224 -> Fmt.string fmt "HMAC_SHA224"
  | HMAC_SHA256 -> Fmt.string fmt "HMAC_SHA256"
  | HMAC_SHA384 -> Fmt.string fmt "HMAC_SHA384"
  | HMAC_SHA512 -> Fmt.string fmt "HMAC_SHA512"
  | AES128_CBC _iv -> Fmt.string fmt "AES128_CBC"
  | AES192_CBC _iv -> Fmt.string fmt "AES192_CBC"
  | AES256_CBC _iv -> Fmt.string fmt "AES256_CBC"
  | SHA_RC4_128 (_iv, _i) -> Fmt.string fmt "SHA_RC4_128"
  | SHA_RC4_40 (_iv, _i) -> Fmt.string fmt "SHA_RC4_40"
  | SHA_3DES_CBC (salt, i) -> Fmt.pf fmt "SHA_3DES_CBC (%a, %d)" Cstruct.hexdump_pp salt i
  | SHA_2DES_CBC (_iv, _i) -> Fmt.string fmt "SHA_2DES_CBC"
  | SHA_RC2_128_CBC (_iv, _i) -> Fmt.string fmt "SHA_RC2_128_CBC"
  | SHA_RC2_40_CBC (_iv, _i) -> Fmt.string fmt "SHA_RC2_40_CBC"
  | PBKDF2 (_salt, _i, _keyl, _prf) -> Fmt.string fmt "PBKDF2"
  | PBES2 (_kdf, _enc) -> Fmt.string fmt "PBES2"
